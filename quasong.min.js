   $(document).ready(function() {
    ...
    queue.push(currentState);
            ...
            function isMoveValid(currentState, object, from, to) {
                ...
                // Triển khai kiểm tra tính hợp lệ dựa trên các điều kiện cụ thể của trò chơi
                if ((currentState.L.wolf > currentState.L.sheep) || (currentState.R.wolf > currentState.R.sheep)) {
        return false; 
    }

    // Triển khai kiểm tra tính hợp lệ dựa trên các điều kiện cụ thể của trò chơi
    if (from === "R" && currentState.R[object] > 0 && (to !== "L" || !isGoalState(currentState))) {
        return true;
    }
            }
            ...
            function displayMoves() {
                ...
                for (var move of moves) {
                    if (move.action === "go") {
                        ...
                        console.log(`Di chuyển ${move.object} từ bờ ${move.from} đến thuyền ${move.to}`);
                    }
                }
            }
        })